...
const appRoutes: Routes = [
    ...
    { path: 'accounts/:id', component: CreateNewAccountComponent, canActivate: [AuthGuard],
        resolve: {account: EditAccountResolverService }},
    { path: 'accounts/edit/:id', component: UpdateAccountComponent, canActivate: [AuthGuard],
        resolve: {account: EditAccountResolverService }},
